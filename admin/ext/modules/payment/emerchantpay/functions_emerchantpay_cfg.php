 ...
 * @return mixed|null
 */
function emp_call_payment_class_method($paymentMethod, $classMethod)
{
 ...
 * @return string
 */
function emp_zfg_select_drop_down_multiple_from_object($attributes, $paymentMethod, $classMethod, $key_value, $key = '')
{
    $select_array = emp_call_payment_class_method($paymentMethod, $classMethod);

    return emp_zfg_select_drop_down_multiple($attributes, $select_array, $key_value, $key);
}
 ...
 * @return string
 */
function emp_cfg_pull_down_zone_classes($zone_class_id, $key = '') {
    ...
    return emp_zfg_select_drop_down_single($zone_class_array, $name, $zone_class_id);
}
 ...
 * @return string
 */
function emp_zfg_select_drop_down_single_from_object($paymentMethod, $classMethod, $key_value, $key = '')
{
    $select_array = emp_call_payment_class_method($paymentMethod, $classMethod);

    return emp_zfg_select_drop_down_single($select_array, $key_value, $key);
}
